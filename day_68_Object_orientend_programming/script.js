...
const ibrahim = new Person('Ibrahim', 'Ohid', 27);
const rafiya = new Person('Rafiya', 'Kawser', 22);
const ebna = new Person('Ebna', 'Osman', 20);

console.log(ibrahim.fullName());
console.log(rafiya.fullName());
console.log(ebna.fullName());